...
public class Ex0_main {
    public static Long ID0 = 315533356L, ID1 = 207544230L, ID2 = null;
    ...
    public static void main(String[] ar) {
        ...
        //  ElevatorAlgo ex0_alg = new ShabatElev3Algo1(Simulator_A.getBuilding());    // Shabat Elev with two trick - replace with your code;
        // ElevatorAlgo ex0_alg = new ShabatElev3Algo(Simulator_A.getBuilding());    // Shabat Elev with two trick - replace with your code;
        ElevatorAlgo ex0_alg = new EL_Algo(Simulator_A.getBuilding());
        //ElevatorAlgo ex0_alg = new algoElevator(Simulator_A.getBuilding());    // Shabat Elev with two trick - replace with your code;
